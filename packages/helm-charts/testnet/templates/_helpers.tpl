...
{{ end }}
      ...
      - name: geth
        ...
        - |-
          ...
          ADDITIONAL_FLAGS="${ADDITIONAL_FLAGS} --proxy.proxiedvalidatoraddress $VALIDATOR_HEX_ADDRESS --proxy.proxy --proxy.internalendpoint :30503 $PROXY_ALLOW_PRIVATE_IP_FLAG"
          {{ end }}
          {{ if .unlock | default false }}
