...
import { DoubleSigningSlasher as DoubleSigningSlasherType } from '../types/DoubleSigningSlasher'
export default async function getInstance(web3: Web3, account: string | null = null) {
  const contract = (new web3.eth.Contract(
    ...
    '0x139E72656fB37f9B8282D9535B351100c6e1B053'
  ) as unknown) as DoubleSigningSlasherType
