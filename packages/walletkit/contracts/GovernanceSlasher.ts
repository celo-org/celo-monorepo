...
import { GovernanceSlasher as GovernanceSlasherType } from '../types/GovernanceSlasher'
export default async function getInstance(web3: Web3, account: string | null = null) {
  const contract = (new web3.eth.Contract(
    ...
    '0xE2b8a28C020FdF8f74325AAb9fa08Aab20e70888'
  ) as unknown) as GovernanceSlasherType
