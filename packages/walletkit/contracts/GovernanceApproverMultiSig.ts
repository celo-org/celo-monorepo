...
import { GovernanceApproverMultiSig as GovernanceApproverMultiSigType } from '../types/GovernanceApproverMultiSig'
export default async function getInstance(web3: Web3, account: string | null = null) {
  const contract = (new web3.eth.Contract(
    ...
    '0xE501A1c6b1cc11fA74ed76aeC09dd399030b93B0'
  ) as unknown) as GovernanceApproverMultiSigType
