  ...
  describe('when running a node', () => {
    ...
    it('should hash current header correctly', async () => {
      ...
      const hash = await contract.methods
        .hashHeader(rlp.encode(reconstructHeaderArray(kit.web3, block)))
        .call()
      console.info('Current block hash is: ' + hash)
      assert.equal(hash, block.hash)
    })

    it('it should parse blockNumber from test header', async () => {
      const contract = await kit._web3Contracts.getElection()
      const header = kit.web3.utils.hexToBytes(
        ''
      )
