...
export enum DynamicEnvVar {
  ...
  KOMENCI_CELOLABS_REWARDS_ADDRESS_AZURE_KEY_VAULT = '{{ context }}_KOMENCI_CELOLABS_REWARDS_ADDRESS_AZURE_KEY_VAULT',
  KOMENCI_FOUNDATION_REWARDS_ADDRESS_AZURE_KEY_VAULT = '{{ context }}_KOMENCI_FOUNDATION_REWARDS_ADDRESS_AZURE_KEY_VAULT',
