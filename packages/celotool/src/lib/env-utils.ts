...
export enum DynamicEnvVar {
  ...
  ODIS_SIGNER_AZURE_KEYSTORE_VAULT_NAME = '{{ context }}_ODIS_SIGNER_AZURE_KEYSTORE_VAULT_NAME',
  ODIS_SIGNER_AZURE_KEYSTORE_SECRET_NAME = '{{ context }}_ODIS_SIGNER_AZURE_KEYSTORE_SECRET_NAME',
}
