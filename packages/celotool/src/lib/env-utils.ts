...
export enum DynamicEnvVar {
  ...
  FORNO_KUBERNETES_CLUSTER_NAME = '{{ context }}_FORNO_KUBERNETES_CLUSTER_NAME',
  FORNO_AZURE_KUBERNETES_RESOURCE_GROUP = '{{ context }}_FORNO_AZURE_KUBERNETES_RESOURCE_GROUP',
  FULL_NODES_KUBERNETES_CLUSTER_NAME = '{{ context }}_FULL_NODES_KUBERNETES_CLUSTER_NAME',
  FULL_NODES_AZURE_KUBERNETES_RESOURCE_GROUP = '{{ context }}_FULL_NODES_AZURE_KUBERNETES_RESOURCE_GROUP',
  ...
  ORACLE_KUBERNETES_CLUSTER_NAME = '{{ context }}_ORACLE_KUBERNETES_CLUSTER_NAME',
  ORACLE_AZURE_KUBERNETES_RESOURCE_GROUP = '{{ context }}_ORACLE_AZURE_KUBERNETES_RESOURCE_GROUP',
  ...
  KOMENCI_KUBERNETES_CLUSTER_NAME = '{{ context }}_KOMENCI_KUBERNETES_CLUSTER_NAME',
  KOMENCI_AZURE_KUBERNETES_RESOURCE_GROUP = '{{ context }}_KOMENCI_AZURE_KUBERNETES_RESOURCE_GROUP',
