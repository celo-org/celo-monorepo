...
export enum envVar {
  ...
  LEADERBOARD_SCHEDULE = 'LEADERBOARD_SCHEDULE',
  LEADERBOARD_IMAGE_REPOSITORY = 'LEADERBOARD_IMAGE_REPOSITORY',
  LEADERBOARD_IMAGE_TAG = 'LEADERBOARD_IMAGE_TAG',
  LEADERBOARD_DATABASE = 'LEADERBOARD_DATABASE',
  LEADERBOARD_TOKEN = 'LEADERBOARD_TOKEN',
  LEADERBOARD_CREDENTIALS = 'LEADERBOARD_CREDENTIALS',
  LEADERBOARD_WEB3 = 'LEADERBOARD_WEB3',
  LEADERBOARD_SPREET = 'LEADERBOARD_SPREET',
  MNEMONIC = 'MNEMONIC',
