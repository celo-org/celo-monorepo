...
export enum DynamicEnvVar {
  ...
  ODIS_SIGNER_BLOCKCHAIN_PROVIDER = '{{ context }}_ODIS_SIGNER_BLOCKCHAIN_PROVIDER',
  ...
  ODIS_SIGNER_DB_DATABASE = '{{ context }}_ODIS_SIGNER_DB_DATABASE',
  ODIS_SIGNER_DB_PASSWORD = '{{ context }}_ODIS_SIGNER_DB_PASSWORD',  
  ODIS_SIGNER_KEYSTORE_AZURE_VAULT_NAME = '{{ context }}_ODIS_SIGNER_KEYSTORE_AZURE_VAULT_NAME',
  ODIS_SIGNER_KEYSTORE_AZURE_SECRET_NAME = '{{ context }}_ODIS_SIGNER_KEYSTORE_AZURE_SECRET_NAME',
}
