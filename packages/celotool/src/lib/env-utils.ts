...
export enum envVar {
  ...
  AZURE_KUBERNETES_CLUSTER_NAME = 'AZURE_KUBERNETES_CLUSTER_NAME',
  AZURE_KUBERNETES_CLUSTER_REGION = 'AZURE_KUBERNETES_CLUSTER_REGION',
  AZURE_KUBERNETES_RESOURCE_GROUP = 'AZURE_KUBERNETES_RESOURCE_GROUP',
  ...
  ELECTION_MIN_VALIDATORS = 'ELECTION_MIN_VALIDATORS',
  ELECTION_MAX_VALIDATORS = 'ELECTION_MAX_VALIDATORS',
  ENV_TYPE = 'ENV_TYPE',
  EPOCH = 'EPOCH',
  EPOCH_REWARDS_FROZEN = 'EPOCH_REWARDS_FROZEN',
  EXCHANGE_FROZEN = 'EXCHANGE_FROZEN',
