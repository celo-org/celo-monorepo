...
export enum envVar {
  ...
  FUNDER_DOCKER_IMAGE_REPOSITORY = 'FUNDER_DOCKER_IMAGE_REPOSITORY',
  FUNDER_DOCKER_IMAGE_TAG = 'FUNDER_DOCKER_IMAGE_TAG',
...
export enum DynamicEnvVar {
  ...
  FUNDER_ADDRESS_AZURE_KEY_VAULT = '{{ context }}_FUNDER_ADDRESS_AZURE_KEY_VAULT',
  FUNDER_CONFIGS_COUNT = '{{ context }}_FUNDER_CONFIGS_COUNT',
  FUNDER_CONFIG_TOKEN = '{{ context }}_FUNDER_CONFIG_{{ index }}_TOKEN',
  FUNDER_CONFIG_ADDRESSES_TO_WATCH = '{{ context }}_FUNDER_CONFIG_{{ index }}_ADDRESSES_TO_WATCH',
  FUNDER_CONFIG_BALANCE_THRESHOLD = '{{ context }}_FUNDER_CONFIG_{{ index }}_BALANCE_THRESHOLD',
  FUNDER_CONFIG_TOPUP_AMOUNT = '{{ context }}_FUNDER_CONFIG_{{ index }}_TOPUP_AMOUNT',
  FUNDER_CONFIG_CRON = '{{ context }}_FUNDER_CONFIG_{{ index }}_CRON',
  FUNDER_NETWORK = '{{ context }}_FUNDER_NETWORK',
