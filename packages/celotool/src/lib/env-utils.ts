...
export enum DynamicEnvVar {
  ...
  ORACLE_AWS_RESOURCE_GROUP_TAG = 'ORACLE_{{ oracleContext }}_AWS_KUBERNETES_RESOURCE_GROUP',
  ...
  ORACLE_GCP_PROJECT_NAME = 'ORACLE_{{ oracleContext }}_GCP_PROJECT_NAME',
  ORACLE_GCP_ZONE = 'ORACLE_{{ oracleContext }}_GCP_ZONE',
