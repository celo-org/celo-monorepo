...
export class WrapperCache {
  ...
  // }
  getBondedDeposits() {
    return this.getWrapper(CeloContract.BondedDeposits)
  }
  // getEscrow() {
  //   return this.getWrapper(CeloContract.Escrow, newEscrow)
  // }
  getExchange() {
    return this.getWrapper(CeloContract.Exchange)
  }
  ...
  // }
  getGoldToken() {
    return this.getWrapper(CeloContract.GoldToken)
  }
  // getGovernance() {
  ...
  // }
  getStableToken() {
    return this.getWrapper(CeloContract.StableToken)
  }
  getValidators() {
    return this.getWrapper(CeloContract.Validators)
  }

  public async getWrapper<C extends keyof CFType>(contract: C) {
    if (this.wrapperCache[contract] == null) {
      const instance = await this.kit.contracts.getContract(contract)
