...
test('should send transaction on simple case', function () { return __awaiter(_this, void 0, void 0, function () {
    var txo, txRes;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, send_tx_1.sendTransaction(txo)];
            case 1:
                txRes = _a.sent();
...
test('should not estimateGas if gas is provided', function () { return __awaiter(_this, void 0, void 0, function () {
    var txo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                txo = txoStub();
                return [4 /*yield*/, send_tx_1.sendTransaction(txo, { estimatedGas: 555 })];
            case 1:
                _a.sent();
...
test('should use inflation factor on gas', function () { return __awaiter(_this, void 0, void 0, function () {
    var txo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                txo = txoStub();
                txo.estimateGasMock.mockResolvedValue(1000);
                return [4 /*yield*/, send_tx_1.sendTransaction(txo, { gasInflationFactor: 2 })];
            case 1:
                _a.sent();
...
test('should forward txoptions to txo.send()', function () { return __awaiter(_this, void 0, void 0, function () {
    var txo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                txo = txoStub();
                return [4 /*yield*/, send_tx_1.sendTransaction(txo, { estimatedGas: 555, gasCurrency: 'XXX', from: '0xAAFFF' })];
            case 1:
                _a.sent();
...
//# sourceMappingURL=send-tx.test.js.map