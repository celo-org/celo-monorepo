...
function newWeb3ContractCache() {
    ...
    var contractCache = new web3_contract_cache_1.Web3ContractCache(kit);
    return contractCache;
}
describe('getContract()', function () {
    var contractCache = newWeb3ContractCache();
    ...
    for (var _i = 0, AllContracts_1 = _1.AllContracts; _i < AllContracts_1.length; _i++) {
...
test('should cache contracts', function () { return __awaiter(void 0, void 0, void 0, function () {
    var contractCache, _i, AllContracts_2, contractName, contract, contractBis;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                contractCache = newWeb3ContractCache();
                _i = 0, AllContracts_2 = _1.AllContracts;
                _a.label = 1;
            case 1:
                if (!(_i < AllContracts_2.length)) return [3 /*break*/, 5];
                contractName = AllContracts_2[_i];
...
//# sourceMappingURL=web3-contract-cache.test.js.map