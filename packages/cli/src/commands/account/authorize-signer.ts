...
export default class AuthorizeSigner extends BaseCommand {
  static description =
  ...
  async run() {
    ...
    let tx: any
    tx = await accounts.authorizeSignerWithSignature(
      res.flags.signer,
      res.flags.role,
      sig.v,
      sig.r,
