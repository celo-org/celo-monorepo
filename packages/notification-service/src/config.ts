...
export const STABLE_TOKEN_ADDRESS = (process.env.STABLE_TOKEN_ADDRESS as string).toLowerCase()
export const GOLD_TOKEN_ADDRESS = (process.env.GOLD_TOKEN_ADDRESS as string).toLowerCase()
