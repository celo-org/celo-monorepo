...
If you're new to Forge / Foundry, we recommend looking through the [Cheatcode Reference](https://getfoundry.sh/reference/cheatcodes/overview#cheatcodes-reference) for a list of useful commands that make writing tests easier.
