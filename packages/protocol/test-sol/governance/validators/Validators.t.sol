...
contract ValidatorsTest is Test, Constants, Utils, ECDSAHelper {
    ...
    function setUp() public {
        ...
        originalValidatorLockedGoldRequirements = ValidatorLockedGoldRequirements({value: 1000, duration: 60 * DAY});

        originalGroupLockedGoldRequirements = GroupLockedGoldRequirements({value: 1000, duration: 100 * DAY});

        originalValidatorScoreParameters =
            ValidatorScoreParameters({exponent: 5, adjustmentSpeed: FixidityLib.newFixedFraction(5, 20)});
    ...
    function _registerValidatorWithSignerHelper() internal returns (bytes memory) {
        ...
        (bytes memory _ecdsaPubKey, uint8 v, bytes32 r, bytes32 s) =
            _generateEcdsaPubKeyWithSigner(validator, signer, signerPk);
    ...
    function _generateEcdsaPubKey(address _account, uint256 _accountPk) internal returns (bytes memory ecdsaPubKey) {
    ...
    function _registerValidatorHelper(address _validator, uint256 _validatorPk) internal returns (bytes memory) {
    ...
    function _registerValidatorGroupHelper(address _group, uint256 numMembers) internal {
        ...
        lockedGold.setAccountTotalLockedGold(_group, originalGroupLockedGoldRequirements.value.mul(numMembers));
    ...
    function _calculateScore(uint256 _uptime, uint256 _gracePeriod) internal returns (uint256) {
        return
            _safeExponent(_max1(_uptime.add(_gracePeriod)), FixidityLib.wrap(originalValidatorScoreParameters.exponent));
    }
}
...
contract ValidatorsTest_Initialize is ValidatorsTest {
    ...
    function test_shouldHaveSetGroupLockedGoldRequirements() public {
        ...
        assertEq(value, originalGroupLockedGoldRequirements.value, "Wrong groupLockedGoldRequirements value.");
        assertEq(duration, originalGroupLockedGoldRequirements.duration, "Wrong groupLockedGoldRequirements duration.");
    }
    ...
    function test_shouldHaveSetValidatorLockedGoldRequirements() public {
        ...
        assertEq(value, originalValidatorLockedGoldRequirements.value, "Wrong validatorLockedGoldRequirements value.");
        assertEq(
            duration,
    ...
    function test_shouldHaveSetValidatorScoreParameters() public {
        ...
        assertEq(exponent, originalValidatorScoreParameters.exponent, "Wrong validatorScoreParameters exponent.");
        assertEq(
            adjustmentSpeed,
...
contract ValidatorsTest_SetGroupLockedGoldRequirements is ValidatorsTest {
    ...
    function test_Reverts_WhenRequirementsAreUnchanged() public {
        ...
        validators.setGroupLockedGoldRequirements(
            originalGroupLockedGoldRequirements.value, originalGroupLockedGoldRequirements.duration
        );
    }
}
...
contract ValidatorsTest_SetValidatorLockedGoldRequirements is ValidatorsTest {
    ...
    function test_Reverts_WhenRequirementsAreUnchanged() public {
        ...
        validators.setValidatorLockedGoldRequirements(
            originalValidatorLockedGoldRequirements.value, originalValidatorLockedGoldRequirements.duration
        );
    }
}
...
contract ValidatorsTest_SetValidatorScoreParameters is ValidatorsTest {
    ...
    function test_Reverts_WhenLockupsAreUnchanged() public {
        ...
        validators.setValidatorScoreParameters(
            originalValidatorScoreParameters.exponent, originalValidatorScoreParameters.adjustmentSpeed.unwrap()
        );
    }
}
...
contract ValidatorsTest_RegisterValidator is ValidatorsTest {
    ...
    function test_ShouldSetValidatorMembershipHistory_WhenAccountHasAuthorizedValidatorSigner() public {
        _registerValidatorWithSignerHelper();
        (uint256[] memory _epoch, address[] memory _membershipGroups,,) = validators.getMembershipHistory(validator);
...
contract ValidatorsTest_DeregisterValidator_WhenAccountHasNeverBeenMemberOfValidatorGroup is ValidatorsTest {
    ...
    function test_ShouldMarkAccountAsNotValidator_WhenAccountHasNeverBeenMemberOfValidatorGroup() public {
        assertTrue(validators.isValidator(validator));
    ...
    function test_ShouldRemoveAccountFromValidatorList_WhenAccountHasNeverBeenMemberOfValidatorGroup() public {
    ...
    function test_ShouldResetAccountBalanceRequirements_WhenAccountHasNeverBeenMemberOfValidatorGroup() public {
        assertTrue(validators.isValidator(validator));
        _deregisterValidator(validator);
        assertEq(validators.getAccountLockedGoldRequirement(validator), 0);
    }

    function test_Emits_ValidatorDeregisteredEvent_WhenAccountHasNeverBeenMemberOfValidatorGroup() public {
        vm.expectEmit(true, true, true, true);
...
contract ValidatorsTest_DeregisterValidator_WhenAccountHasBeenMemberOfValidatorGroup is ValidatorsTest {
    uint256 public constant INDEX = 0;
    ...
    function test_ShouldMarkAccountAsNotValidator_WhenValidatorNoLongerMemberOfValidatorGroup() public {
        vm.prank(group);
    ...
    function test_ShouldRemoveAccountFromValidatorList_WhenValidatorNoLongerMemberOfValidatorGroup() public {
        address[] memory ExpectedRegisteredValidators = new address[](0);
    ...
    function test_ShouldResetAccountBalanceRequirements_WhenValidatorNoLongerMemberOfValidatorGroup() public {
        vm.prank(group);
        validators.removeMember(validator);
        timeTravel(originalValidatorLockedGoldRequirements.duration.add(1));
    ...
    function test_Emits_ValidatorDeregisteredEvent_WhenValidatorNoLongerMemberOfValidatorGroup() public {
        vm.prank(group);
        validators.removeMember(validator);
        timeTravel(originalValidatorLockedGoldRequirements.duration.add(1));
        vm.expectEmit(true, true, true, true);
...
contract ValidatorsTest_Affiliate_WhenGroupAndValidatorMeetLockedGoldRequirements is ValidatorsTest {
...
contract ValidatorsTest_Affiliate_WhenValidatorIsAlreadyAffiliatedWithValidatorGroup is ValidatorsTest {
    address otherGroup;
    ...
    function test_Emits_ValidatorDeaffiliatedEvent_WhenValidatorNotMemberOfThatValidatorGroup() public {
        vm.expectEmit(true, true, true, true);
    ...
    function test_ShouldRemoveValidatorFromGroupMembershipList_WhenValidatorIsMemberOfThatValidatorGroup() public {
    ...
    function test_ShouldUpdateValidatorsMembershipHistory_WhenValidatorIsMemberOfThatValidatorGroup() public {
        vm.prank(group);
        validators.addFirstMember(validator, address(0), address(0));
        ...
        (uint256[] memory epochs, address[] memory groups, uint256 lastRemovedFromGroupTimestamp, uint256 tail) =
    ...
    function test_Emits_ValidatorGroupMemberRemovedEvent_WhenValidatorIsMemberOfThatValidatorGroup() public {
        vm.prank(group);
        validators.addFirstMember(validator, address(0), address(0));
...
contract ValidatorsTest_Deaffiliate is ValidatorsTest {
    ...
    function test_ShouldRemoveValidatorFromGroupMembershipList_WhenValidatorIsMemberOfAffiliatedGroup() public {
        address[] memory expectedMembersList = new address[](0);
    ...
    function test_Emits_ValidatorGroupMemberRemovedEvent_WhenValidatorIsMemberOfAffiliatedGroup() public {
        vm.prank(group);
        validators.addFirstMember(validator, address(0), address(0));
...
contract ValidatorsTest_UpdateEcdsaPublicKey is ValidatorsTest {
    ...
    function test_ShouldSetValidatorEcdsaPubKey_WhenCalledByRegisteredAccountsContract() public {
        (bytes memory _newEcdsaPubKey,,,) = _generateEcdsaPubKeyWithSigner(address(accounts), signer, signerPk);
        vm.prank(address(accounts));
    ...
    function test_Emits_ValidatorEcdsaPublicKeyUpdatedEvent_WhenCalledByRegisteredAccountsContract() public {
        (bytes memory _newEcdsaPubKey,,,) = _generateEcdsaPubKeyWithSigner(address(accounts), signer, signerPk);
    ...
    function test_Reverts_WhenPublicKeyDoesNotMatchSigner_WhenCalledByRegisteredAccountsContract() public {
        (bytes memory _newEcdsaPubKey,,,) =
            _generateEcdsaPubKeyWithSigner(address(accounts), otherValidator, otherValidatorPk);
    ...
    function test_Reverts_whenNotCalledByRegisteredAccountsContract() public {
        (bytes memory _newEcdsaPubKey,,,) = _generateEcdsaPubKeyWithSigner(validator, signer, signerPk);
...
contract ValidatorsTest_UpdatePublicKeys is ValidatorsTest {
    ...
    function test_ShouldSetValidatorNewBlsPubKeyAndEcdsaPubKey_WhenCalledByRegisteredAccountsContract() public {
        (bytes memory _newEcdsaPubKey,,,) = _generateEcdsaPubKeyWithSigner(address(accounts), signer, signerPk);

        ph.mockSuccess(ph.PROOF_OF_POSSESSION(), abi.encodePacked(validator, newBlsPublicKey, newBlsPop));

        vm.prank(address(accounts));
        validators.updatePublicKeys(validator, signer, _newEcdsaPubKey, newBlsPublicKey, newBlsPop);

        (bytes memory actualEcdsaPubKey, bytes memory actualBlsPublicKey,,,) = validators.getValidator(validator);
    ...
    function test_Reverts_WhenPublicKeyMatchesSigner_WhenNotCalledByRegisteredAccountsContract() public {
        (bytes memory _newEcdsaPubKey,,,) = _generateEcdsaPubKeyWithSigner(validator, signer, signerPk);
...
contract ValidatorsTest_UpdateBlsPublicKey is ValidatorsTest {
    ...
    function test_Reverts_WhenPublicKeyIsNot96Bytes() public {
        ph.mockSuccess(ph.PROOF_OF_POSSESSION(), abi.encodePacked(validator, wrongBlsPublicKey, newBlsPop));
    ...
    function test_Reverts_WhenProofOfPossessionIsNot48Bytes() public {
        ph.mockSuccess(ph.PROOF_OF_POSSESSION(), abi.encodePacked(validator, newBlsPublicKey, wrongBlsPop));
...
contract ValidatorsTest_RegisterValidatorGroup is ValidatorsTest {
    ...
    function test_ShouldAddAccountToListOfValidatorGroup() public {
        ...
        assertEq(validators.getRegisteredValidatorGroups().length, ExpectedRegisteredValidatorGroups.length);
    ...
    function test_ShouldSetAccountLockedGoldRequirements() public {
        _registerValidatorGroupHelper(group, 1);
        assertEq(validators.getAccountLockedGoldRequirement(group), originalGroupLockedGoldRequirements.value);
    }
...
contract ValidatorsTest_DeregisterValidatorGroup_WhenGroupHasHadMembers is ValidatorsTest {
    ...
    function test_Emits_ValidatorGroupDeregistered_whenItHasBeenMoreThanGrouplockedGoldRequirementDuration() public {
        vm.prank(group);
        validators.removeMember(validator);
...
contract ValidatorsTest_AddMember is ValidatorsTest {
        ...
        public
    {
        ...
        for (uint256 i = 2; i < maxGroupSize.add(1); i++) {
            ...
            vm.prank(_validator1);
            validators.affiliate(group);
            lockedGold.setAccountTotalLockedGold(group, originalGroupLockedGoldRequirements.value.mul(_numMembers));
    ...
    function test_Reverts_WhenGroupDoesNotHaveMember_WhenGroupDoesNotMeetLockedGoldRequirements() public {
        lockedGold.setAccountTotalLockedGold(group, originalGroupLockedGoldRequirements.value.sub(11));
    ...
    function test_Reverts_WhenGroupAlreadyHasMember_WhenGroupDosNotMeetLockedGoldRequirements() public {
        lockedGold.setAccountTotalLockedGold(group, originalGroupLockedGoldRequirements.value.mul(2).sub(11));
        vm.prank(group);
        validators.addFirstMember(validator, address(0), address(0));
...
contract ValidatorsTest_SetNextCommissionUpdate is ValidatorsTest {
    ...
    function test_Emits_ValidatorGroupCommissionUpdateQueuedEvent() public {
        ...
        emit ValidatorGroupCommissionUpdateQueued(
            group, newCommission, commissionUpdateDelay.add(uint256(block.number))
        );
        vm.prank(group);
        validators.setNextCommissionUpdate(newCommission);
    }
...
contract ValidatorsTest_CalculateEpochScore is ValidatorsTest {
    ...
    function test_ShouldCalculateScoreCorrectly_WhenUptimeInInterval0AND1() public {
        ...
        FixidityLib.Fraction memory gracePeriod = FixidityLib.newFixedFraction(validators.downtimeGracePeriod(), 1);
    ...
    function test_Reverts_WhenUptimeGreaterThan1() public {
        FixidityLib.Fraction memory uptime = FixidityLib.add(FixidityLib.fixed1(), FixidityLib.newFixedFraction(1, 10));
...
contract ValidatorsTest_CalculateGroupEpochScore is ValidatorsTest {
    ...
    function test_ShouldCalculateGroupScoreCorrectly_WhenThereIs1ValidatorGroup() public {
        ...
        (uint256[] memory unwrapedUptimes, uint256 expectedScore) = _computeGroupUptimeCalculation(uptimes);
...
contract ValidatorsTest_UpdateValidatorScoreFromSigner is ValidatorsTest {
    ...
    function test_ShouldUpdateValidatorScore_WhenUptimeInRange0And1() public {
        uint256 _expectedScore = FixidityLib.multiply(
    ...
    function test_ShouldUpdateValidatorScore_WhenValidatorHasNonZeroScore() public {
        ...
        _expectedScore = FixidityLib.add(
            FixidityLib.multiply(
                FixidityLib.subtract(FixidityLib.fixed1(), originalValidatorScoreParameters.adjustmentSpeed),
...
contract ValidatorsTest_UpdateMembershipHistory is ValidatorsTest {
    ...
    function test_ShouldOverwritePreviousEntry_WhenChangingGroupsInSameEpoch() public {
        ...
        for (uint256 i = 0; i < numTest; i++) {
            ...
            (actualMembershipHistoryEpochs, actualMembershipHistoryGroups,,) =
                validators.getMembershipHistory(validator);
    ...
    function test_ShouldAlwaysStoreMostRecentMemberships_WhenChangingGroupsMoreThanMembershipHistoryLength() public {
        expectedMembershipHistoryGroups.push(address(0));
        expectedMembershipHistoryEpochs.push(validatorRegistrationEpochNumber);
...
contract ValidatorsTest_GetAccountLockedGoldRequirement is ValidatorsTest {
    ...
    function test_ShouldDecreaseRequirementDuration1SecondAfterRemoval_WhenRemovingMembers() public {
        ...
        for (uint256 i = 0; i < numMembers; i++) {
            ...
            uint256 requirementExpiry = originalGroupLockedGoldRequirements.duration.add(removalTimestamp);
...
contract ValidatorsTest_DistributeEpochPaymentsFromSigner is ValidatorsTest {
    ...
    function setUp() public {
        ...
        expectedTotalPayment = FixidityLib.fromFixed(
            FixidityLib.multiply(expectedScore, FixidityLib.newFixedFraction(maxPayment, FixidityLib.fixed1().unwrap()))
        );

        expectedGroupPayment =
            FixidityLib.fromFixed(FixidityLib.multiply(commission, FixidityLib.newFixed(expectedTotalPayment)));

        uint256 remainingPayment = expectedTotalPayment.sub(expectedGroupPayment);

        expectedDelegatedPayment =
            FixidityLib.fromFixed(FixidityLib.multiply(FixidityLib.newFixed(remainingPayment), delegatedFraction));

        expectedValidatorPayment = remainingPayment.sub(expectedDelegatedPayment);

        halfExpectedTotalPayment = FixidityLib.fromFixed(
            FixidityLib.multiply(expectedScore, FixidityLib.newFixedFraction(maxPayment, FixidityLib.fixed1().unwrap()))
        ).div(2);

        halfExpectedGroupPayment =
            FixidityLib.fromFixed(FixidityLib.multiply(commission, FixidityLib.newFixed(halfExpectedTotalPayment)));

        remainingPayment = halfExpectedTotalPayment.sub(halfExpectedGroupPayment);

        halfExpectedDelegatedPayment =
            FixidityLib.fromFixed(FixidityLib.multiply(FixidityLib.newFixed(remainingPayment), delegatedFraction));
        ...
        ph.mockReturn(
            ...
            abi.encodePacked(
                _calculateScore(uptime.unwrap(), validators.downtimeGracePeriod()), FixidityLib.fixed1().unwrap()
            )
        );
    ...
    function test_ShouldReturnTheExpectedTotalPayment_WhenValidatorAndGroupMeetBalanceRequirements() public {
        validators.distributeEpochPaymentsFromSigner(validator, maxPayment);
    ...
    function test_ShouldPayGroup_WhenValidatorAndGroupMeetBalanceRequirementsAndNoPaymentDelegated() public {
        expectedDelegatedPayment = 0;
        expectedValidatorPayment = expectedTotalPayment.sub(expectedGroupPayment);
