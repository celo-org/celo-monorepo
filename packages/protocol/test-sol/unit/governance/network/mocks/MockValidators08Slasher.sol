...
contract MockValidators08Slasher is IValidators {
  ...
  function mintStableToEpochManager(uint256) external pure {
    revert("stub");
  }
  ...
  function getAccountLockedGoldRequirement(address) external pure returns (uint256) {
    revert("stub");
  }
  ...
  function getGroupNumMembers(address) external pure returns (uint256) {
    revert("stub");
  }
  function getTopGroupValidators(address, uint256) external pure returns (address[] memory) {
    revert("stub");
  }
  ...
  function getGroupsNumMembers(address[] calldata) external pure returns (uint256[] memory) {
    revert("stub");
  }
  function getNumRegisteredValidators() external pure returns (uint256) {
    revert("stub");
  }
  ...
  function computeEpochReward(address, uint256, uint256) external pure returns (uint256) {
    revert("stub");
  }
  function getMembershipHistoryLength() external pure returns (uint256) {
    revert("stub");
  }
  function getGroupMembers(address) external pure returns (address[] memory) {
    revert("stub");
  }
