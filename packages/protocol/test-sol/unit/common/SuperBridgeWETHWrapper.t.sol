...
import {SuperBridgeWETHWrapper} from "@celo-contracts-8/common/SuperBridgeWETHWrapper.sol";
...
contract SuperBridgeWETHWrapperTestBase is Test {
    SuperBridgeWETHWrapper public wrapper;
  ...
  event WrappedAndBridged(
    ...
    function setUp() public {
        ...
        wrapper = new SuperBridgeWETHWrapper(true);
...
contract SuperBridgeWETHWrapper_Initialize is SuperBridgeWETHWrapperTestBase {
    ...
    function test_Revert_ZeroAddress_WethLocal() public {
        SuperBridgeWETHWrapper newWrapper = new SuperBridgeWETHWrapper(true);
        vm.prank(owner);
...
contract SuperBridgeWETHWrapper_WrapAndBridge is SuperBridgeWETHWrapperTestBase {
    function test_SuperBridge_ShouldWrapAndSend() public {
        ...
        assertEq(mockBridge.lastMinGasLimit(), 0);
