...
const DefaultConfig = {
  ...
  lockedGold: {
    unlockingPeriod: (60 * 60 * 24 * 3) / 24, // 3 days divided by 24 to accelerate
  },
  oracles: {
  ...
  validators: {
    groupLockedGoldRequirements: {
      ...
      duration: (60 * 24 * 60 * 60) / 24, // 60 days divided by 24 to accelerate
    },
    ...
    maxGroupSize: '5',
    slashingPenaltyResetPeriod: (60 * 60 * 24 * 30) / 24, // 30 Days divided by 24 to accelerate
