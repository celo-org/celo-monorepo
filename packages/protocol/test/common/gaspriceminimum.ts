...
const Testt: TesttContract = artifacts.require('Testt')
...
contract('GasPriceMinimum', (accounts: string[]) => {
  ...
  it('should ', async () => {
    try {
      ...
      console.log('before testt')
      const testt = await Testt.new({ from: accounts[0], gas: 30000000 })
      console.log('after testt')
      console.log('my number', (await testt.test()).toString())

      console.log('before new')
      gasPriceMinimum = await GasPriceMinimum.new(true, { from: accounts[0], gas: 30000000 })
  ...
  //     registry = await Registry.new(true)
  //     console.log("before testt");
  //     const testt = await Testt.new()
  //     console.log("after testt");
  //     console.log("my number", (await testt.test()).toString());

  //     console.log("before new");
  //     gasPriceMinimum = await GasPriceMinimum.new(true, {from: accounts[0], gas:13000000})
  //     console.log("after new");
