...
import {
  ...
  TestGovernanceSlasherContract,
  TestGovernanceSlasherInstance,
} from 'types'

const Accounts: AccountsContract = artifacts.require('Accounts')
const Validators: ValidatorsTestContract = artifacts.require('ValidatorsTest')
const GovernanceSlasher: TestGovernanceSlasherContract = artifacts.require('TestGovernanceSlasher')
...
contract('GovernanceSlasher', (accounts: string[]) => {
  ...
  let slasher: TestGovernanceSlasherInstance
