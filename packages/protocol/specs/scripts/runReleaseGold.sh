...
certoraRun specs/harnesses/BeneficiaryHarness.sol:Beneficiary \
    ...
    --link ReleaseGoldHarness:lockedGold2=LockedGoldHarness ReleaseGoldHarness:election=ElectionHarness  ElectionHarness:lockedGold=LockedGoldHarness ReleaseGoldHarness:beneficiary=Beneficiary \
