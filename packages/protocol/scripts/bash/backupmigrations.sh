...
if [ -d migrations.bak ]; then
  ...
  # TODO EN: updated the path for this -- do so in uncommented backupmigrations as well
  cp migrations.bak/09_01_stableToken_EUR.* migrations/
  # TODO EN: added the path for this -- do so in uncommented backupmigrations as well
