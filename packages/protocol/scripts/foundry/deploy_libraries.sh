...
for LIB_PATH in "${LIBRARIES_PATH[@]}"; do
    ...
    create_library_out=`$FORGE_EXEC create $LIB_PATH --from 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 --rpc-url $ANVIL_RPC_URL --private-key 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80 --broadcast --json`
