...
const T_SYSTEMS_BENEFICIARY_ADDRESS: Address = '0xF1FAD09c73F92E1395F4e5B716CD0e809C9052E2'

// ======= One time payment contract
const ONE_TIME_PAYMENT_AMOUNT_USD = 5311.33 // 2023 compensation
const ONE_TIME_PAYMENT_AMOUNT_CELO = ONE_TIME_PAYMENT_AMOUNT_USD / CELO_PRICE_USD
const ONE_TIME_PAYMENT_RG: ReleaseGoldConfig = {
  identifier: 'T-Systems One Time Payment',
  releaseStartTime: new Date('12/17/2023').toISOString(), // prev contract start time Fri, Dec 16, 2022, 10:34 AM AST:
  releaseCliffTime: 0, // renewing contract, therefore no cliff
  numReleasePeriods: 1,
  releasePeriod: 1, // available immediately
...
const MONTHLY_PAYMENT_RG: ReleaseGoldConfig = {
  identifier: 'T-Systems Monthly Payment',
  releaseStartTime: new Date('12/17/2023').toISOString(), // prev contract start time Fri, Dec 16, 2022, 10:34 AM AST:
  releaseCliffTime: 0, // renewing contract, therefore no cliff
