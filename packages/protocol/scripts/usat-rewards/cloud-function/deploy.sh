...
gcloud functions deploy "$FUNCTION_NAME" \
    ...
    --set-env-vars "GCS_BUCKET=$BUCKET,DRY_RUN=$DRY_RUN,MAX_PER_WALLET=${MAX_PER_WALLET:-5000000},MAX_TOTAL_PER_RUN=${MAX_TOTAL_PER_RUN:-5000000000},DUNE_POLL_SECONDS=${DUNE_POLL_SECONDS:-1500},MIN_GAS_CELO=${MIN_GAS_CELO:-1},MIN_BALANCE_USAT=${MIN_BALANCE_USAT:-1500}" \
