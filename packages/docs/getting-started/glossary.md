...
Software Development Kit. Generally, a suite of developer tools that enable applications to be built on a platform. Celo's SDK currently comprises two components, [DAppKit](../developer-guide/overview/introduction/dappkit/) and [ContractKit](../developer-guide/overview/introduction/contractkit/).
