...
The Baklava testnet is the best place to get started running a validator, or test out new validator configurations before deploying to the [Release Candidate Network](../rc1/) or, in the future, Mainnet.
