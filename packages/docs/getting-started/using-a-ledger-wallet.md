...
Start by installing the Celo application and setting a PIN on your Ledger device by following steps 1 and 2 on https://www.ledger.com/start/.
...
```
 ...
 Coinfigure the Celo CLI so that it uses a cLabs node on the Alfajores network. 
