...
\+ **new ContractKit**(`web3`: Web3, `wallet?`: [ReadOnlyWallet](../interfaces/_contractkit_src_wallets_wallet_.readonlywallet.md)): *[ContractKit](_contractkit_src_kit_.contractkit.md)*
