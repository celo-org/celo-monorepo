...
* [computeSharedSecret](_contractkit_src_wallets_wallet_.walletbase.md#computesharedsecret)
...
* [removeAccount](_contractkit_src_wallets_wallet_.walletbase.md#removeaccount)
