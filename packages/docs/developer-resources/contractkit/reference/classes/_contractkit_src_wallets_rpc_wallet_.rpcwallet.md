...
* [computeSharedSecret](_contractkit_src_wallets_rpc_wallet_.rpcwallet.md#computesharedsecret)
...
* [removeAccount](_contractkit_src_wallets_rpc_wallet_.rpcwallet.md#removeaccount)
