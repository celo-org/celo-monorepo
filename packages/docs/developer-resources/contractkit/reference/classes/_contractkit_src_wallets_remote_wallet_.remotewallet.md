...
* [WalletBase](_contractkit_src_wallets_wallet_.walletbase.md)‹TSigner›
...
* [computeSharedSecret](_contractkit_src_wallets_remote_wallet_.remotewallet.md#computesharedsecret)
...
* [removeAccount](_contractkit_src_wallets_remote_wallet_.remotewallet.md#removeaccount)
