...
* [attestationFeeRequired](_contractkit_src_wrappers_attestations_.attestationswrapper.md#attestationfeerequired)
...
* [lookupPhoneNumbers](_contractkit_src_wrappers_attestations_.attestationswrapper.md#lookupphonenumbers)
...
▸ (`phoneNumber`: string, `account`: [Address](../modules/_contractkit_src_base_.md#address)): *Promise‹[AttestationStat](../interfaces/_contractkit_src_wrappers_attestations_.attestationstat.md)›*
...
▸ (`phoneNumber`: string, `account`: [Address](../modules/_contractkit_src_base_.md#address), `issuer`: [Address](../modules/_contractkit_src_base_.md#address)): *Promise‹[AttestationStateForIssuer](../interfaces/_contractkit_src_wrappers_attestations_.attestationstateforissuer.md)›*
...
▸ **complete**(`phoneNumber`: string, `account`: [Address](../modules/_contractkit_src_base_.md#address), `issuer`: [Address](../modules/_contractkit_src_base_.md#address), `code`: string): *Promise‹[CeloTransactionObject](_contractkit_src_wrappers_basewrapper_.celotransactionobject.md)‹void››*
...
`account` | [Address](../modules/_contractkit_src_base_.md#address) | The account of the attestation |
...
▸ **findMatchingIssuer**(`phoneNumber`: string, `account`: [Address](../modules/_contractkit_src_base_.md#address), `code`: string, `issuers`: string[]): *Promise‹string | null›*
...
▸ **getActionableAttestations**(`phoneNumber`: string, `account`: [Address](../modules/_contractkit_src_base_.md#address)): *Promise‹[ActionableAttestation](../interfaces/_contractkit_src_wrappers_attestations_.actionableattestation.md)[]›*
...
▸ **getNonCompliantIssuers**(`phoneNumber`: string, `account`: [Address](../modules/_contractkit_src_base_.md#address)): *Promise‹[Address](../modules/_contractkit_src_base_.md#address)[]›*
...
▸ **lookupPhoneNumbers**(`phoneNumberHashes`: string[]): *Promise‹Record‹string, Record‹string, [AttestationStat](../interfaces/_contractkit_src_wrappers_attestations_.attestationstat.md)›››*
...
**Returns:** *Promise‹Record‹string, Record‹string, [AttestationStat](../interfaces/_contractkit_src_wrappers_attestations_.attestationstat.md)›››*

___

###  request

▸ **request**(`phoneNumber`: string, `attestationsRequested`: number): *Promise‹[CeloTransactionObject](_contractkit_src_wrappers_basewrapper_.celotransactionobject.md)‹void››*
...
▸ **revealPhoneNumberToIssuer**(`phoneNumber`: string, `account`: [Address](../modules/_contractkit_src_base_.md#address), `issuer`: [Address](../modules/_contractkit_src_base_.md#address), `serviceURL`: string): *Promise‹Response›*
...
▸ **selectIssuers**(`phoneNumber`: string): *[CeloTransactionObject](_contractkit_src_wrappers_basewrapper_.celotransactionobject.md)‹void›*
...
▸ **validateAttestationCode**(`phoneNumber`: string, `account`: [Address](../modules/_contractkit_src_base_.md#address), `issuer`: [Address](../modules/_contractkit_src_base_.md#address), `code`: string): *Promise‹boolean›*
...
`account` | [Address](../modules/_contractkit_src_base_.md#address) | The account which requested attestation |
...
▸ **waitForSelectingIssuers**(`phoneNumber`: string, `account`: [Address](../modules/_contractkit_src_base_.md#address), `timeoutSeconds`: number, `pollDurationSeconds`: number): *Promise‹void›*
