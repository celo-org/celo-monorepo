...
▸ **setAccount**(`name`: string, `dataEncryptionKey`: string, `walletAddress`: [Address](../modules/_base_.md#address), `proofOfPossession`: [Signature](_utils_signature_utils_.signature.md) | null): *[CeloTransactionObject](_wrappers_basewrapper_.celotransactionobject.md)‹void›*
...
`proofOfPossession` | [Signature](_utils_signature_utils_.signature.md) &#124; null | null | Signature from the wallet address key over the sender's address  |
...
▸ **setWalletAddress**(`walletAddress`: [Address](../modules/_base_.md#address), `proofOfPossession`: [Signature](_utils_signature_utils_.signature.md) | null): *[CeloTransactionObject](_wrappers_basewrapper_.celotransactionobject.md)‹void›*
...
`proofOfPossession` | [Signature](_utils_signature_utils_.signature.md) &#124; null | null |
