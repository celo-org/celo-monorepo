...
- `consensus_istanbul_blocks_missedbyusinarow`: (_Future release_) Counts the blocks for which this validator was elected but not included in the child's parent seal in a row.  Consider monitoring the gauge.
