...
- An [overview](https://docs.celo.org/overview) of the high-level architecture of Celo
- Tutorials to get you started with the [Celo SDK](https://docs.celo.org/developer-guide/start) and the [Celo networks](https://docs.celo.org/getting-started/choosing-a-network)
- Reference documentation about the [Celo protocol](https://docs.celo.org/celo-codebase/protocol) and [wallet](https://docs.celo.org/celo-codebase/wallet)
- How to make technical [contributions](https://docs.celo.org/community/contributing) to the project and community

## Quick Reference

- CELO Owners
  - [Start here](https://docs.celo.org/celo-owner-guide/quick-start) to find out how to access your account and earn rewards for participating in the network.
- Validator & Node Operators
  - Check out the [Validator overview page](https://docs.celo.org/validator-guide/overview).
  - Consider running a node on the [Baklava testnet](https://docs.celo.org/getting-started/baklava-testnet) before getting started on Mainnet.
  - Learn more about running nodes on [Mainnet](https://docs.celo.org/getting-started/mainnet).
- Developers
  - Start at the [developer tools page](https://docs.celo.org/developer-guide/overview) for help building a DApp or service on the Celo network.
- Integration Guide
  - [This section](https://docs.celo.org/developer-guide/integrations) includes guides on common ways for integrating Celo into your service. This may be relevant for custodians, exchanges or other services that intend to custody Celo assets like CELO and cUSD.
...
The [Alfajores Testnet](https://docs.celo.org/getting-started/alfajores-testnet) is the first of several networks designed for testing and for developers to experiment and learn more about Celo. You can set up an account, receive funds, and try out the Celo Wallet and Celo CLI. [Get started here](https://docs.celo.org/getting-started/alfajores-testnet/faucet).

{% hint style="warning" %}
The Alfajores Testnet’s tokens hold no real world economic value. The entirety of the testnet’s data will be reset on a regular basis. This will erase your accounts, their balance and your transaction history. Your use of the Alfajores Tesnet is subject to the [Alfajores Testnet Disclaimer](https://docs.celo.org/important-information/alfajores-testnet-disclaimer).
{% endhint %}

The [Baklava Testnet](https://docs.celo.org/getting-started/baklava-testnet) is the second Celo test network after Alfajores. You can use it to participate in the The Great Celo Stake Off. Subject to these Terms and Conditions, eligible participants will have the opportunity to receive CELO at the Mainnet launch of the Celo Protocol. The Stake Off will operate in phases, with each phase focusing on a different part of the protocol or infrastructure to test.
...
Celo is a project with a mission of financial inclusion that consists entirely of open source code, is deployed as an open, decentralized runtime, and promotes open governance. Make it your project too. Please [get involved](https://docs.celo.org/community/contributing)!

### Useful Links <a id="useful-links"></a>

Learn more about Celo:

- [Overview of Celo’s architecture ](https://docs.celo.org/overview)
...
- [Using the Mobile Wallet](https://docs.celo.org/getting-started/alfajores-testnet/using-the-mobile-wallet) on the Alfajores Testnet
- [Introduction to the CLI ](https://docs.celo.org/command-line-interface/introduction)on the Alfajores Testnet
