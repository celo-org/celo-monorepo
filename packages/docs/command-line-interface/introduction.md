...
{% hint style="info" %}
We are currently deploying the CLI with only Node.js v18.x. If you are running a different version of Node.js, consider using [NVM](https://github.com/nvm-sh/nvm#installation-and-update) to manage your node versions. e.g. with: `nvm install 18 && nvm use 18`
{% endhint %}
