...
Since light clients need not trust full nodes, as they can verify their work, this also provides the 'permissionless on-ramp' for users to receive Celo native asset or Celo Dollars without already holding it that is missing in other proof-of-stake networks.
