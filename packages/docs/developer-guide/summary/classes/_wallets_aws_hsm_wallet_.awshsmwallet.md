...
+ **new AwsHsmWallet**\(`awsCredentials?`: KMS.ClientConfiguration\): [_AwsHsmWallet_](_wallets_aws_hsm_wallet_.awshsmwallet.md)
...
**Returns:** [_AwsHsmWallet_](_wallets_aws_hsm_wallet_.awshsmwallet.md)
...
▸ **getAddressFromKeyId**\(`keyId`: string\): _Promise‹_[_Address_](../modules/_base_.md#address)_›_
