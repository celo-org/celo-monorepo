...
public class RNVerifierServiceModule extends ReactContextBaseJavaModule {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      switch (intent.getAction()) {
        case PushNotificationToSMSService.EVENT_NAME_NOTIFY_SMS_LOG:
          ...
          List<SMSLog> smsLogs = intent.getParcelableArrayListExtra(
            PushNotificationToSMSService.EXTRA_SMS_LOGS
          );
          ...
          try {
            ...
            sendEvent(
              ...
              PushNotificationToSMSService.EVENT_SMS_SENT,
              smsArray
            );
          } catch (Exception e) {
  ...
  private void togglePingServer(boolean enable) {
    if (enable) {
      ...
      mTask =
        mExec.scheduleAtFixedRate(
          new PingServerTask(),
          0,
          TIMER_INTERVAL_DEFAULT_VALUE,
