...
describe('AccountUtils', () => {
  ...
  describe('.normalizeMnemonic()', () => {
    it('should normalize phrases with and without accents', async () => {
    ...
    it('should not normalize accents when the word is from a different language', async () => {
    ...
    it('should normalize capitalized words to lowercase', async () => {
      const mnemonic =
