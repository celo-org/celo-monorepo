...
var debug = debug_1.default('in-memory-wallet');
...
exports.testAddress = address_1.toChecksumAddress(account);
function getTestWallet() {
    ...
    var onSessionProposal = function (proposal) {
        ...
        return client.approve({ proposal: proposal, response: response });
    };
