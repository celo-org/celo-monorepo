...
var testTx = {
    ...
    to: address_1.privateKeyToAddress('1234567890abcdef1234567890abcdef1234567890abcdef1234567890abbdef'),
    chainId: CHAIN_ID,
...
describe('WalletConnectWallet tests', function () {
    ...
    if (E2E) {
        testWallet = in_memory_wallet_1.getTestWallet();
    }
    else {
        jest
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(address_1.eqAddress(accounts[0], in_memory_wallet_1.testAddress)).toBe(true);
                    return [2 /*return*/];
            }
        });
    }); });
    describe('operations with an unknown address', function () {
        var unknownAddress = address_1.privateKeyToAddress('1234567890abcdef1234567890abcdef1234567890abcdef1234567890abbdef');
        ...
        it('signPersonalMessage()', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        hexString = address_1.ensureLeading0x(Buffer.from('hello').toString('hex'));
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
        ...
        it('decrypt()', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        encrypted = ecies_1.ECIES.Encrypt(Buffer.from(address_1.trimLeading0x(address_1.privateKeyToPublicKey(in_memory_wallet_1.testPrivateKey)), 'hex'), Buffer.from(decryptMessage));
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
        ...
        it('computeSharedSecret()', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        otherPubKey = address_1.privateKeyToPublicKey('1234567890abcdef1234567890abcdef1234567890abcdef1234567890abbdef');
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        valid = signatureUtils_1.verifySignature(hexString, signedMessage, in_memory_wallet_1.testAddress);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        signedMessage = _a.sent();
                        expect(signedMessage).not.toBeUndefined();
                        valid = signatureUtils_1.verifyEIP712TypedDataSigner(TYPED_DATA, signedMessage, in_memory_wallet_1.testAddress);
                        expect(valid).toBeTruthy();
                        return [2 /*return*/];
                }
            });
        ...
        it('signTransaction()', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        signedTx = _b.sent();
                        _a = wallet_base_1.recoverTransaction(signedTx.raw), recoveredSigner = _a[1];
                        expect(address_1.eqAddress(recoveredSigner, in_memory_wallet_1.testAddress)).toBe(true);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        expect(sharedSecret).toEqual(ecdh_1.computeSharedSecret(in_memory_wallet_1.testPrivateKey, otherPubKey));
                        return [2 /*return*/];
                }
            });
        }); });
