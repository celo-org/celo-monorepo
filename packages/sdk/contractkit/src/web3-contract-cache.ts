...
import { newAttestations } from '@celo/abis/types/web3/Attestations'
import { newBlockchainParameters } from '@celo/abis/types/web3/BlockchainParameters'
import { newDoubleSigningSlasher } from '@celo/abis/types/web3/DoubleSigningSlasher'
import { newDowntimeSlasher } from '@celo/abis/types/web3/DowntimeSlasher'
import { newElection } from '@celo/abis/types/web3/Election'
import { newEpochRewards } from '@celo/abis/types/web3/EpochRewards'
import { newEscrow } from '@celo/abis/types/web3/Escrow'
import { newFederatedAttestations } from '@celo/abis/types/web3/FederatedAttestations'
import { newFeeCurrencyWhitelist } from '@celo/abis/types/web3/FeeCurrencyWhitelist'
import { newFeeHandler } from '@celo/abis/types/web3/FeeHandler'
import { newFreezer } from '@celo/abis/types/web3/Freezer'
import { newGoldToken } from '@celo/abis/types/web3/GoldToken'
import { newGovernance } from '@celo/abis/types/web3/Governance'
import { newIERC20 } from '@celo/abis/types/web3/IERC20'
import { newLockedGold } from '@celo/abis/types/web3/LockedGold'
import { newMetaTransactionWallet } from '@celo/abis/types/web3/MetaTransactionWallet'
import { newMetaTransactionWalletDeployer } from '@celo/abis/types/web3/MetaTransactionWalletDeployer'
import { newMultiSig } from '@celo/abis/types/web3/MultiSig'
import { newOdisPayments } from '@celo/abis/types/web3/OdisPayments'
import { newProxy } from '@celo/abis/types/web3/Proxy'
import { newRandom } from '@celo/abis/types/web3/Random'
import { newRegistry } from '@celo/abis/types/web3/Registry'
import { newSortedOracles } from '@celo/abis/types/web3/SortedOracles'
import { newValidators } from '@celo/abis/types/web3/Validators'
...
import { newGrandaMento } from '@celo/abis/types/web3/mento/GrandaMento'
import { newReserve } from '@celo/abis/types/web3/mento/Reserve'
import { newStableToken } from '@celo/abis/types/web3/mento/StableToken'

import { newMentoFeeHandlerSeller } from '@celo/abis/types/web3/MentoFeeHandlerSeller'
import { newUniswapFeeHandlerSeller } from '@celo/abis/types/web3/UniswapFeeHandlerSeller'
