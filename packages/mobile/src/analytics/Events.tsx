...
> = AnalyticsPropsList[EventName] extends undefined
  ? {}
  : {
      subEvents?: string[]
      properties: AnalyticsPropsList[EventName]
    }
...
enum SendEvents {
  ...
  // send_selectRecipient = 'send_selectRecipient',
}
...
export const AnalyticsEvents = { ...SendEvents, ...OnboardingEvents }
export type AnalyticsEventType = SendEvents | OnboardingEvents

export type AnalyticsPropertiesList = {
  ...
  [OnboardingEvents.phone_number_set]: undefined
  [OnboardingEvents.invalid_phone_number]: undefined
}

// export declare type AnalyticsEventParams<AnalyticsParamList, EventName extends keyof AnalyticsEvents> = {
//   params: AnalyticsParamList[EventName]
// }
