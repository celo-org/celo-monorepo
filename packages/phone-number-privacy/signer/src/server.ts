...
export function createServer() {
  ...
  addMeteredEndpoint(Endpoints.DOMAIN_QUOTA_STATUS, (req, res) =>
    domainService.handleGetDomainQuotaStatus(req, res)
  )
  addMeteredEndpoint(Endpoints.DOMAIN_SIGN, (req, res) =>
    domainService.handleGetDomainRestrictedSignature(req, res)
  )
  addMeteredEndpoint(Endpoints.DISABLE_DOMAIN, (req, res) =>
    domainService.handleDisableDomain(req, res)
  )
  // curl -v "http://localhost:8080/domain/quotaStatus" -H "Authorization: 0xdaf63ea42a092e69b2001db3826bc81dc859bffa4d51ce8943fddc8ccfcf6b2b1f55d64e4612e7c028791528796f5a62c1d2865b184b664589696a08c83fc62a00" -H "Content-Type: application/json" -d '{"domain": {"name":"ODIS Sequential Delay Domain", "version":"1"}}'
