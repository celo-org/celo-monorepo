...
import Page, { COLOR_PATH } from 'src/experienceKits/brandkit/common/Page'
...
import {
  ...
  GRAY_PALETTE,
  PRIMARY_PALETTE,
} from 'src/experienceKits/common/data'
import PageHeadline from 'src/experienceKits/common/PageHeadline'
