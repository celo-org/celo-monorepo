...
import Palette from 'src/experienceKits/brandkit/color/Palette'
import Page, { LOGO_PATH } from 'src/experienceKits/brandkit/common/Page'
import Judgement, { Value } from 'src/experienceKits/brandkit/logo/Judgement'
import LogoExample, { Logos } from 'src/experienceKits/brandkit/logo/LogoExample'
import LogoWithBackground from 'src/experienceKits/brandkit/logo/LogoWithBackground'
import { Digital, Print } from 'src/experienceKits/brandkit/logo/Minimums'
import {
  GLYPH_TRACKING,
  LOGO_PKG_TRACKING,
  trackDownload,
} from 'src/experienceKits/brandkit/tracking'
import { brandStyles, GAP } from 'src/experienceKits/common/constants'
import { BACKGROUND_PALETTE } from 'src/experienceKits/common/data'
import DownloadButton from 'src/experienceKits/brandkit/DownloadButton'
import SectionTitle from 'src/experienceKits/common/SectionTitle'
import TripplePairing from 'src/experienceKits/common/TripplePairing'
        ...
        >
          <AspectRatio ratio={714 / 357} style={styles.clearspaceImage}>
            <Image
              resizeMethod="resize"
              resizeMode="contain"
              source={require('src/experienceKits/brandkit/images/ClearspaceImage.png')}
        ...
        first={
          <>
            <Judgement is={Value.Bad}>
              <LogoWithBackground
                image={require('src/experienceKits/brandkit/images/lilah.jpg')}
                type="dark"
              />
            </Judgement>
            <Judgement is={Value.Good}>
              <LogoWithBackground
                ...
                image={require('src/experienceKits/brandkit/images/lilahOverlay.jpg')}
                type="white"
              />
            </Judgement>
          </>
