...
# ============================================================
# SuperchainConfig proxy at 0x31bEef32135c90AE8E56Fb071B3587de289Aaf77
# EIP-1967 admin slot → ProxyAdmin 0xF7d7A3d3bb8aBb6829249B3D3aD3d525D052027e
...
cast rpc anvil_setStorageAt \
  ...
  0x000000000000000000000000f7d7a3d3bb8abb6829249b3d3ad3d525d052027e \
  -r $RPC_URL

# ============================================================
# 2. Convert ProxyAdminOwner EOA into a Gnosis Safe
# ============================================================
# ProxyAdminOwner for Celo Sepolia is 0x5e60d897Cd62588291656b54655e98ee73f0aabF
# which is an EOA. The superchain-ops simulation framework expects a Gnosis Safe.
...
echo ""
echo "=== Validation ==="
echo "--- SuperchainConfig Proxy ---"
echo "Admin: $(cast storage 0x31bEef32135c90AE8E56Fb071B3587de289Aaf77 0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103 -r $RPC_URL)"
