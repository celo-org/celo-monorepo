...
export const NETWORKS = {
  mainnet: {
    ...
    addresses: {
      ...
      ANCHOR_STATE_REGISTRY_PROXY: '0x8fE58d2168b5412Cf1Bd212cE6137f8b7300222d',
      SUPERCHAIN_CONFIG_PROXY: '0x95703e0982140D16f8ebA6d158FccEde42f04a4C',
      CELO_SUPERCHAIN_CONFIG_PROXY: '0x25035d2233d099f0BA710ca1e5a3834842870C66',
      PROTOCOL_VERSIONS_PROXY: '0x1b6dEB2197418075AB314ac4D52Ca1D104a8F663',
      PERMISSIONED_DELAYED_WETH_PROXY: '0x91FA5B653aFe81A79890A93ad83768A04cc011b4',
  ...
  sepolia: {
    ...
    addresses: {
      ...
      ANCHOR_STATE_REGISTRY_PROXY: '0xe689F6d101a6aFeBddB093c59D4fB5B3087561a7',
      SUPERCHAIN_CONFIG_PROXY: '0x31bEef32135c90AE8E56Fb071B3587de289Aaf77',
      CELO_SUPERCHAIN_CONFIG_PROXY: '0x7934c0D58df75F597F62dB898Ec537B5945BA643',
      PROTOCOL_VERSIONS_PROXY: '0x0e2d45F3393C3A02ebf285F998c5bF990A1541cd',
      PERMISSIONED_DELAYED_WETH_PROXY: '0x5D27C0E30b0e9cEa56936e9326AdCEE480D2ab08',
  ...
  chaos: {
    ...
    addresses: {
      ...
      ANCHOR_STATE_REGISTRY_PROXY: '0xA1660A69B22C67Cb119610b1b5c575F2656d2836',
      ...
      PERMISSIONED_DELAYED_WETH_PROXY: '0x5ae246558A40095C6D7ec12Cbd92C8a7EF89f219',
...
const IMPL_TABLE = {
  ...
  AnchorStateRegistry: {
    ...
    '0xeb69cc681e8d4a557b30dffbad85affd47a2cf2e': 'v5.0.0', // Mainnet & Sepolia (Jovian)
  ...
  CeloSuperchainConfig: {
    ...
    '0xa59b2ebf8231f0e31508bd18e9185beb5ab1c038': 'v5.0.0', // Mainnet & Sepolia (Jovian)
  },
  DelayedWETH: {
    ...
    '0xb86a464cc743440fddaa43900e05318ef4818b29': 'v5.0.0', // Mainnet & Sepolia (Jovian)
...
export const SINGLETON_ADDRS = {
  v5: {
    ...
    chaos: {
      MIPS: '0x9DD9Fd5a9ed48d12A2ADb7525972069C078fE0Ec',
      PreimageOracle: '0xD59BB1D50DfeaDc2cC3a7BED43c3bc4065B0ed4B',
    },
  },
  v4: {
    sepolia: {
...
// Human-friendly labels for well-known Safe addresses (cLabs, Council, etc.)
// Used by buildKnownAddrs() to annotate addresses in the UI.
export const KNOWN_LABELS = {
  mainnet: {
    '0x9eb44da23433b5caa1c87e35594d15fceb08d34d': 'cLabs Safe',
    '0xc03172263409584f7860c25b6eb4985f0f6f4636': 'Council Safe',
  },
  sepolia: {
    '0x769b480a8036873a2a5eb01fe39278e5ab78bb27': 'cLabs Safe',
    '0x3b00043e8c82006fbe5f56b47f9889a04c20c5d6': 'Council Safe',
  },
  chaos: {},
}
