...
if [ "${NETWORK}" == "chaos" ]; then
  ...
  PROXY_ADMIN_OWNER="0x6F8DB5374003c9ffa7084d8b65c57655963766a9"
  ...
  PROOF_MATURITY_DELAY_SECONDS=7200
  DISPUTE_GAME_FINALITY_DELAY_SECONDS=3600
...
#    --mips-version value                         MIPS version. (default: 7) [$DEPLOYER_MIPS_VERSION]
