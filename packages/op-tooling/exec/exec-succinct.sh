...
case $VERSION in
  ...
  v201) SIGNER_FILE="$REPO_ROOT/secrets/.env.signers.succinct201"; USE_GC=true  ;;
esac
...
case $VERSION in
  ...
  v2)
    ...
    ;;
  v201)
    # TODO(v201): confirm rosters once .env.signers.succinct201 is finalized.
    # Placeholder mirrors v2 rosters for cLabs/Council and v1/v102 rosters for GC.
    CLABS_SIGNERS=(0Bd 21e 4D8 74b 812 8b4)
    COUNCIL_SIGNERS=(148 2BE 5f7 6FD B96 C91)
    GC_SIGNERS=(C96 D80)
    ;;
...
case $VERSION in
  ...
  v102)
    ...
    ;;
  v2)
    # Jovian succ-v2: Multicall3 batch — setImplementation(42, impl) + transferOwnership(cLabs).
    ...
    ;;
  v201)
    # succ-v201: Multicall3 batch — single setImplementation(42, newImpl). No transferOwnership.
