...
# check version
case $VERSION in
  "v2"|"v3"|"v4"|"v5"|"succ"|"succ-v102"|"succ-v2")
...
if [ "$VERSION" = "v2" ]; then
  ...
  TARGET=0x503c51b8de2bc78d5f83c179b786b2aa1c454635
  TX_CALLDATA=
elif [ "$VERSION" = "succ" ]; then
...
elif [ "$VERSION" = "succ-v102" ]; then
  PARENT_SAFE_NONCE=25
  CLABS_SAFE_NONCE=22
  COUNCIL_SAFE_NONCE=24
  GRAND_CHILD_NONCE=6
  TARGET=0xcA11bde05977b3631167028862bE2a173976CA11
  TX_CALLDATA=
elif [ "$VERSION" = "succ-v2" ]; then
  PARENT_SAFE_NONCE=28
  CLABS_SAFE_NONCE=26
  COUNCIL_SAFE_NONCE=28
  TARGET=0xcA11bde05977b3631167028862bE2a173976CA11
  TX_CALLDATA=
fi
...
# concat cLabs sigs
if [ "$USE_INTERNAL_CLABS" = "true" ]; then
  SIGNER_1_LOWER=$(to_lower "$MOCKED_SIGNER_1")
  SIGNER_2_LOWER=$(to_lower "$MOCKED_SIGNER_2")
  if [[ $SIGNER_1_LOWER < $SIGNER_2_LOWER ]]; then
    CLABS_SIG=0x${CLABS_SIG_1:2}${CLABS_SIG_2:2}
  else
    CLABS_SIG=0x${CLABS_SIG_2:2}${CLABS_SIG_1:2}
  fi
else
  EXTERNAL_ACCOUNT_LOWER=$(to_lower "$EXTERNAL_ACCOUNT")
  SIGNER_2_LOWER=$(to_lower "$MOCKED_SIGNER_2")
  if [[ $EXTERNAL_ACCOUNT_LOWER < $SIGNER_2_LOWER ]]; then
...
if [ -z "$GRAND_CHILD_MULTISIG" ]; then
  if [ "$USE_INTERNAL_COUNCIL" = "true" ]; then
    SIGNER_3_LOWER=$(to_lower "$MOCKED_SIGNER_3")
    SIGNER_4_LOWER=$(to_lower "$MOCKED_SIGNER_4")
    if [[ $SIGNER_3_LOWER < $SIGNER_4_LOWER ]]; then
    ...
    EXTERNAL_ACCOUNT_LOWER=$(to_lower "$EXTERNAL_ACCOUNT")
    SIGNER_4_LOWER=$(to_lower "$MOCKED_SIGNER_4")
    if [[ $EXTERNAL_ACCOUNT_LOWER < $SIGNER_4_LOWER ]]; then
  ...
  GC_LOWER=$(to_lower "$GRAND_CHILD_MULTISIG")
  SIGNER_4_LOWER=$(to_lower "$MOCKED_SIGNER_4")
  if [[ $GC_LOWER < $SIGNER_4_LOWER ]]; then
