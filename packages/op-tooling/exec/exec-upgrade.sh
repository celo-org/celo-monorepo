...
#
# Supported:
#   mainnet: v2, v3, v4, v5, succ-v1, succ-v102, succ-v2, succ-v201, succ-v210, eigenda-cert-v3
...
case "${NETWORK}-${VERSION}" in
  ...
  # Multicall3 aggregate3:
  #   1. EigenDACertVerifierRouter(0x2ea418AE1852bfC79e18B37E55F278F9c598AA08).addCertVerifier(25624000, 0xd9C4dA492c60e92e2B53abB5Bea7Aa4b8aA5b181)
  "mainnet-eigenda-cert-v3")
    USE_GC=false
    REFUND_RECEIVER=0x95ffac468e37ddeef407ffef18f0cc9e86d8f13b
    SIGNER_FILE="$REPO_ROOT/secrets/.env.signers.eigendacertv3"
    SIG_SUFFIX=""
    CLABS_SIGNERS=(0Bd 21e 4D8 74b 812 8b4)
    COUNCIL_SIGNERS=(148 2BE 5f7 6FD B96 C91)
    PARENT_SAFE_NONCE=31
    CLABS_SAFE_NONCE=33
    COUNCIL_SAFE_NONCE=31
    TARGET_ADDRESS=$MULTICALL3
    CALLDATA=
    ;;
  ...
  *)
    ...
    echo "Supported:" >&2
    echo "  mainnet: v2, v3, v4, v5, succ-v1, succ-v102, succ-v2, succ-v201, succ-v210, eigenda-cert-v3" >&2
