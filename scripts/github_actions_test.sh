...
yarn --cwd packages/protocol run make-release -b $NEW_BRANCH -n $NETWORK -p proposal.json -r report.json -i packages/protocol/releaseData/initializationData/release$VERSION.json --forno;
